...
{
    // Vamos hacer una inyeccion de dependecnia del servicio de configuraciones
    //
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        // => optionsBuilder.UseSqlServer("Server=DESKTOP-REDKEOB;Database=VENTAS;Integrated Security=True;TrustServerCertificate=True");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Venta>(entity =>
        {
            ...
            entity.HasIndex(e => e.FechaHora, "FECHA_HORA_IDX");
            ...
            entity.HasOne(d => d.Cliente).WithMany(p => p.Venta)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_CLIENTE_VENTAS");
            ...
            entity.HasOne(d => d.Vendedor).WithMany(p => p.Venta)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("FK_VENDEDOR_VENTAS");
        });
        modelBuilder.HasSequence("SEC_CAJA");
        modelBuilder.HasSequence("SEC_VENDEDOR");
